...
const template = [[1,,"ul",["fileList"],[,[[1,"if","multiple"]]],[[1,,"li",["file"],[,[[1,"for","fileData in dataList"],[,"draggable","true"],[,"data-file-data-uid","{fileData |uid }"]]],[[1,,"div",["filePreviewWrapper"],,[[1,1,"IfThen",,[,[[,"if","fileData |_isImage"]]],[[1,,"OpalLoader",["fileLoader"],[,[[1,"unless","fileData.url |or(fileData.dataURI)"],[,"size","s"],[,"shown",""]]],],[1,,"img",["filePreview"],[,[[1,"if","fileData.url |or(fileData.dataURI)"],[,"src","{fileData.url |or(fileData.dataURI)}"],[,"draggable","false"]]],]]],[1,,"svg",["fileIcon"],[,[[1,"unless","fileData |_isImage"],[,"stroke-width","2"]]],[[1,,"use",,[,[[,"xlink:href","#OpalIcon__iconFile"]]],]]]]],[1,,"span",["fileName"],,[[3,"{fileData.name}"]]],[1,,"button",["btnRemoveFile"],[,[[,"type","button"]]],[[1,,"svg",["btnRemoveFileIcon"],[,[[,"stroke-width","2"]]],[[1,,"use",,[,[[,"xlink:href","#OpalIcon__iconCross"]]],]]]]]]]]],[1,,"div",["dropZone"],[,[[,"error","{errorMessage |bool }"]]],[[1,,"div",["dropZoneErrorMessageWrapper"],[,[[1,"if","multiple"]]],[[1,,"span",["dropZoneErrorMessage"],,[[3,"{errorMessage}"]]]]],[1,,"span",["dropZoneContent"],,[[1,1,"IfThen",,[,[[,"if","multiple"]]],[[3,"{\"Перетащите файлы в эту область или\" |t }"],[1,,"br",,,],[1,,"button",["btnSelectFiles"],[,[[,"type","button"],[,"tabindex","{disabled |cond(-1, 0) }"]]],[[3,"{\"нажмите для выбора в проводнике\" |t }"]]]]],[1,,"OpalButton",["btnSelectFile"],[,[[1,"unless","multiple"],[,"size","s"],[,"tabIndex","{disabled |cond(-1, 0) }"]]],[[3,"{buttonText}"]]]]],[1,1,"IfElse",,[,[[,"if","multiple"]]],[[1,,"div",["file2"],[,[[1,"if","dataList.length"]]],[[1,,"a",,[,[[1,"if","dataList |get(0) |key(\"url\")"],[,"href","{dataList |get(0) |key(\"url\") }"],[,"target","_blank"],[,"tabindex","{disabled |cond(-1, 0) }"]]],[[3,"{dataList |get(0) |key(\"name\") }"]]],[1,1,"IfElse",,[,[[,"if","dataList |get(0) |key(\"url\")"]]],[[3,"{dataList |get(0) |key(\"name\") }"]]]]],[1,,"div",["placeholder"],[,[[1,"unless","dataList.length"]]],[[3,"{placeholder}"]]]]]]],[1,,"button",["btnClear"],[,[[1,"unless","multiple"],[,"type","button"],[,"shown","{dataList.length |bool }"],[,"tabindex","{disabled |cond(-1, 0) }"]]],[[1,,"OpalIcon",["btnClearIcon"],[,[[,"name","cross"]]],]]],[1,,"input",["filesInput"],[,[[,"type","file"],[,"multiple","{multiple}"]]],]];
