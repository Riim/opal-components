        ...
        if (this.errorMessage) {
            ...
            if (this.multiple ||
                (evt.target.tagName != 'A' &&
                    evt.target !=
                        (btnSelectFileEl = this.$('btnSelectFile').element) &&
                    !opal_components_common_1.nodeContains(btnSelectFileEl, evt.target, this.element))) {
...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".OpalFileInput{position:relative;width:400px;vertical-align:middle}.OpalFileInput:not([multiple]){display:inline-block}.OpalFileInput[multiple]{display:block;-webkit-box-sizing:border-box;box-sizing:border-box;padding:12px;border:1px solid var(--grayColor800, hsl(0,0%,80%));border-radius:3px;color:var(--grayColor300, hsl(0,0%,30%));font-size:1rem;line-height:1.5}.OpalFileInput .OpalFileInput__fileList{margin:0;padding:0;list-style:none}.OpalFileInput .OpalFileInput__file{position:relative;margin-bottom:10px;padding:12px 52px 12px 20px;border-radius:3px;background:var(--grayColor950, hsl(0,0%,95%));cursor:move}.OpalFileInput .OpalFileInput__file[ghost]{opacity:.4}.OpalFileInput .OpalFileInput__filePreviewWrapper{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;margin-right:10px;width:48px;height:48px;vertical-align:middle;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.OpalFileInput .OpalFileInput__fileLoader{border:0}.OpalFileInput .OpalFileInput__filePreview{max-width:100%;max-height:100%;border:0;border-radius:3px}.OpalFileInput .OpalFileInput__fileIcon{width:36px;height:36px;stroke:currentColor;stroke-linecap:butt;stroke-linejoin:miter;fill:none}.OpalFileInput .OpalFileInput__fileName{vertical-align:middle;font-weight:700}.OpalFileInput .OpalFileInput__btnRemoveFile{position:absolute;top:0;right:10px;bottom:0;display:-webkit-box;display:-ms-flexbox;display:flex;margin:auto;width:42px;height:42px;border:0;background:0 0;opacity:.5;cursor:pointer;-webkit-transition:opacity .1s;-o-transition:opacity .1s;transition:opacity .1s;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.OpalFileInput .OpalFileInput__btnRemoveFile:hover{opacity:1}.OpalFileInput .OpalFileInput__btnRemoveFile:active{-webkit-transform:translateY(1px);-ms-transform:translateY(1px);transform:translateY(1px)}.OpalFileInput .OpalFileInput__btnRemoveFileIcon{display:block;width:24px;height:24px;stroke:currentColor;stroke-linecap:butt;stroke-linejoin:miter;fill:none}.OpalFileInput .OpalFileInput__dropZone{cursor:pointer;-webkit-transition:border-color .1s linear;-o-transition:border-color .1s linear;transition:border-color .1s linear}.OpalFileInput .OpalFileInput__dropZone:hover .OpalFileInput__placeholder{color:var(--textColor600, hsl(208,9%,21.6%))}.OpalFileInput .OpalFileInput__dropZone[hovering]{border-color:var(--primaryColor500, hsl(208,94%,50%))}.OpalFileInput .OpalFileInput__dropZone[hovering] .OpalFileInput__dropZoneContent{pointer-events:none}.OpalFileInput .OpalFileInput__dropZone[hovering] .OpalFileInput__placeholder{color:var(--textColor600, hsl(208,9%,21.6%))}.OpalFileInput .OpalFileInput__dropZoneErrorMessageWrapper{position:absolute;top:0;right:0;bottom:0;left:0;display:none;border-radius:inherit;background:inherit;white-space:nowrap;font-size:0}.OpalFileInput .OpalFileInput__dropZoneErrorMessageWrapper::after{display:inline-block;width:0;height:100%;content:'';vertical-align:middle}.OpalFileInput .OpalFileInput__dropZoneErrorMessage{color:var(--dangerColor500, hsl(4,90%,58%));vertical-align:middle;font-size:1rem}.OpalFileInput .OpalFileInput__btnSelectFiles{display:inline;padding:0;border:0;background:0 0;color:var(--primaryColor500, hsl(208,94%,50%));font:inherit;cursor:inherit}.OpalFileInput .OpalFileInput__btnSelectFile{margin-right:10px;vertical-align:middle}.OpalFileInput .OpalFileInput__file2{display:inline-block;overflow:hidden;vertical-align:middle;-o-text-overflow:ellipsis;text-overflow:ellipsis}.OpalFileInput .OpalFileInput__file2 a{color:var(--primaryColor500, hsl(208,94%,50%))}.OpalFileInput .OpalFileInput__placeholder{display:inline-block;color:var(--textColor750, hsl(208,9%,27%));vertical-align:middle;-webkit-transition:color .1s linear;-o-transition:color .1s linear;transition:color .1s linear;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.OpalFileInput:not([multiple]) .OpalFileInput__dropZone{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-sizing:border-box;box-sizing:border-box;padding:6px 36px 6px 12px;width:100%;border:1px solid var(--grayColor700, hsl(0,0%,70%));border-top-color:var(--grayColor650, hsl(0,0%,65%));border-bottom-color:var(--grayColor800, hsl(0,0%,80%));border-radius:3px;background:#fff;-webkit-box-shadow:inset 0 1px rgba(0,0,0,.1);box-shadow:inset 0 1px rgba(0,0,0,.1);color:var(--textColor500, hsl(208,9%,18%));text-decoration:none;text-shadow:none;white-space:nowrap;font:16px/24px Verdana,Geneva,sans-serif;font-weight:400;-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;-webkit-tap-highlight-color:transparent}.OpalFileInput[multiple] .OpalFileInput__dropZone{position:relative;padding:25px;border:2px dashed var(--grayColor600, hsl(0,0%,60%));border-radius:5px;background:var(--grayColor950, hsl(0,0%,95%));color:var(--grayColor500, hsl(0,0%,50%));text-align:center}.OpalFileInput[multiple] .OpalFileInput__dropZone[error] .OpalFileInput__dropZoneErrorMessageWrapper{display:block}.OpalFileInput .OpalFileInput__btnClear{position:absolute;top:0;right:9px;bottom:0;display:none;margin:auto;padding:0;width:24px;height:24px;border:0;background:0 0;color:var(--grayColor500, hsl(0,0%,50%));cursor:pointer;-webkit-transition:color .1s linear;-o-transition:color .1s linear;transition:color .1s linear}.OpalFileInput .OpalFileInput__btnClear[shown]{display:block}.OpalFileInput .OpalFileInput__btnClear:hover{color:var(--textColor500, hsl(208,9%,18%))}.OpalFileInput .OpalFileInput__btnClear:focus{outline:0}body:not(._noFocusHighlight) .OpalFileInput .OpalFileInput__btnClear:focus{outline:1px solid var(--primaryColor500, hsl(208,94%,50%))}.OpalFileInput .OpalFileInput__btnClear:active{-webkit-transform:translateY(1px);-ms-transform:translateY(1px);transform:translateY(1px)}.OpalFileInput .OpalFileInput__btnClearIcon{position:absolute;top:0;right:0;bottom:0;left:0;display:block;margin:auto;width:16px;height:16px}.OpalFileInput:hover:not([multiple]) .OpalFileInput__dropZone{border-color:var(--grayColor600, hsl(0,0%,60%));border-top-color:var(--grayColor550, hsl(0,0%,55%));border-bottom-color:var(--grayColor700, hsl(0,0%,70%))}.OpalFileInput:hover[multiple] .OpalFileInput__dropZone{border-color:var(--grayColor400, hsl(0,0%,40%))}.OpalFileInput[valid] .OpalFileInput__dropZone,.OpalFileInput[valid] .OpalFileInput__dropZone:focus{border-color:var(--successColor500, hsl(122,40%,48%))}.OpalFileInput[valid=no] .OpalFileInput__dropZone,.OpalFileInput[valid=no] .OpalFileInput__dropZone:focus{border-color:var(--dangerColor500, hsl(4,90%,58%))}.OpalFileInput:not([multiple]) .OpalFileInput__dropZone[error]{border-color:var(--dangerColor500, hsl(4,90%,58%))}.OpalFileInput[disabled]{opacity:.5;pointer-events:none}.OpalFileInput[disabled] .OpalFileInput__dropZone{background:var(--grayColor900, hsl(0,0%,90%))}.OpalFileInput .OpalFileInput__filesInput{display:none}";
