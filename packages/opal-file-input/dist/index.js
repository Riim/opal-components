...
const template = [[1,["fileList"],,,"ul",[,[[1,"if","multiple"]]],[[1,["file"],,,"li",[,[[1,"for","fileData in dataList"],[,"draggable","true"],[,"data-file-data-uid","{fileData |uid }"]]],[[1,["filePreviewWrapper"],,,"div",,[[1,,,1,"cond",[,[[,"if","fileData |_isImage"]]],[[1,["fileLoader"],,,"OpalLoader",[,[[1,"unless","fileData.url |or(fileData.dataURI)"],[,"size","s"],[,"shown",""]]],],[1,["filePreview"],,,"img",[,[[1,"if","fileData.url |or(fileData.dataURI)"],[,"src","{fileData.url |or(fileData.dataURI)}"],[,"draggable","false"]]],]]],[1,["fileIcon"],,,"svg",[,[[1,"unless","fileData |_isImage"],[,"stroke-width","2"]]],[[1,,,,"use",[,[[,"xlink:href","#OpalIcon__iconFile"]]],]]]]],[1,["fileName"],,,"span",,[[3,"{fileData.name}"]]],[1,["btnRemoveFile"],,,"button",[,[[,"type","button"]]],[[1,["btnRemoveFileIcon"],,,"svg",[,[[,"stroke-width","2"]]],[[1,,,,"use",[,[[,"xlink:href","#OpalIcon__iconCross"]]],]]]]]]]]],[1,["dropZone"],,,"div",[,[[,"error","{errorMessage |bool }"]]],[[1,["dropZoneErrorMessageWrapper"],,,"div",[,[[1,"if","multiple"]]],[[1,["dropZoneErrorMessage"],,,"span",,[[3,"{errorMessage}"]]]]],[1,["dropZoneContent"],,,"span",,[[1,,,1,"cond",[,[[,"if","multiple"]]],[[3,"{\"Перетащите файлы в эту область или\" |t }"],[1,,,,"br",,],[1,["btnSelectFiles"],,,"button",[,[[,"type","button"],[,"tabindex","{disabled |cond(-1, 0) }"]]],[[3,"{\"нажмите для выбора в проводнике\" |t }"]]]]],[1,["btnSelectFile"],,,"OpalButton",[,[[1,"unless","multiple"],[,"size","s"],[,"tabIndex","{disabled |cond(-1, 0) }"]]],[[3,"{buttonText}"]]]]],[1,,,1,"cond",[,[[,"unless","multiple"]]],[[1,["file2"],,,"div",[,[[1,"if","dataList.length"]]],[[1,,,,"a",[,[[1,"if","dataList |get(0) |key(\"url\")"],[,"href","{dataList |get(0) |key(\"url\") }"],[,"target","_blank"],[,"tabindex","{disabled |cond(-1, 0) }"]]],[[3,"{dataList |get(0) |key(\"name\") }"]]],[1,,,1,"cond",[,[[,"unless","dataList |get(0) |key(\"url\")"]]],[[3,"{dataList |get(0) |key(\"name\") }"]]]]],[1,["placeholder"],,,"div",[,[[1,"unless","dataList.length"]]],[[3,"{placeholder}"]]]]]]],[1,["btnClear"],,,"button",[,[[1,"unless","multiple"],[,"type","button"],[,"shown","{dataList.length |bool }"],[,"tabindex","{disabled |cond(-1, 0) }"]]],[[1,["btnClearIcon"],,,"OpalIcon",[,[[,"name","cross"]]],]]],[1,["filesInput"],,,"input",[,[[,"type","file"],[,"multiple","{multiple}"]]],]];
