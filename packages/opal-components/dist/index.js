(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@riim/opal-group"), require("@riim/opal-text-input-validator"), require("@riim/opal-notification"), require("@riim/opal-popover"), require("@riim/opal-editable-text"), require("@riim/opal-radio-group"), require("@riim/opal-tree-select"), require("@riim/opal-switch-menu"), require("@riim/opal-checkbox"), require("@riim/opal-input-validator"), require("@riim/opal-dropdown"), require("@riim/opal-switch"), require("@riim/opal-loader"), require("@riim/opal-file-attach"), require("@riim/opal-autosuggest"), require("@riim/opal-input-mask"), require("@riim/opal-focus-highlight-controller"), require("@riim/opal-slider"), require("@riim/opal-components-common"), require("@riim/opal-date-input"), require("@riim/opal-router"), require("@riim/opal-select-validator"), require("@riim/opal-form"), require("@riim/opal-button"), require("@riim/opal-icon"), require("@riim/opal-filtered-list"), require("@riim/opal-multirow"), require("@riim/opal-tag-select"), require("@riim/opal-sign-button"), require("@riim/opal-text-input"), require("@riim/opal-calendar"), require("@riim/opal-tree-tag-select"), require("@riim/opal-loaded-list"), require("@riim/opal-select"), require("@riim/opal-multiselect"), require("@riim/opal-tabs"), require("@riim/opal-tree-list"), require("@riim/opal-modal"));
	else if(typeof define === 'function' && define.amd)
		define(["@riim/opal-group", "@riim/opal-text-input-validator", "@riim/opal-notification", "@riim/opal-popover", "@riim/opal-editable-text", "@riim/opal-radio-group", "@riim/opal-tree-select", "@riim/opal-switch-menu", "@riim/opal-checkbox", "@riim/opal-input-validator", "@riim/opal-dropdown", "@riim/opal-switch", "@riim/opal-loader", "@riim/opal-file-attach", "@riim/opal-autosuggest", "@riim/opal-input-mask", "@riim/opal-focus-highlight-controller", "@riim/opal-slider", "@riim/opal-components-common", "@riim/opal-date-input", "@riim/opal-router", "@riim/opal-select-validator", "@riim/opal-form", "@riim/opal-button", "@riim/opal-icon", "@riim/opal-filtered-list", "@riim/opal-multirow", "@riim/opal-tag-select", "@riim/opal-sign-button", "@riim/opal-text-input", "@riim/opal-calendar", "@riim/opal-tree-tag-select", "@riim/opal-loaded-list", "@riim/opal-select", "@riim/opal-multiselect", "@riim/opal-tabs", "@riim/opal-tree-list", "@riim/opal-modal"], factory);
