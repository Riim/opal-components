...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".OpalButton{padding:0;border:0;background:0 0;color:inherit;font:inherit;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.OpalButton:not([viewType=clean]){position:relative;display:inline-block;-webkit-box-sizing:border-box;box-sizing:border-box;padding:7px 23px;border-radius:3px;background:#546778;color:#fff;vertical-align:middle;text-align:center;text-decoration:none;text-shadow:none;font:16px/24px Verdana,Geneva,sans-serif;font-weight:400;-webkit-transition:background .1s linear;-o-transition:background .1s linear;transition:background .1s linear;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;-webkit-tap-highlight-color:transparent}.OpalButton:not([viewType=clean])::-moz-focus-inner{padding:0;border:0}.OpalButton:not([viewType=clean])[size=s]{padding:4px 14px;font-size:14px;line-height:21px}.OpalButton:not([viewType=clean]):hover{background:#597791}.OpalButton:not([viewType=clean]):focus{outline:0}body:not(._noFocusHighlight) .OpalButton:not([viewType=clean]):focus::after{position:absolute;top:2px;right:2px;bottom:2px;left:2px;border:1px solid rgba(255,255,255,.8);border-radius:inherit;content:'';pointer-events:none}.OpalButton:not([viewType=clean]):active,.OpalButton:not([viewType=clean])[checked]{background:#43484c}.OpalButton:not([viewType=clean])[loading]{background-image:-o-linear-gradient(315deg,rgba(255,255,255,.35) 0,rgba(255,255,255,.35) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.35) 50%,rgba(255,255,255,.35) 75%,transparent 75%,transparent 100%);background-image:linear-gradient(135deg,rgba(255,255,255,.35) 0,rgba(255,255,255,.35) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.35) 50%,rgba(255,255,255,.35) 75%,transparent 75%,transparent 100%);background-size:30px 30px;-webkit-animation:OpalButton__loadingAnimation 3s linear infinite;animation:OpalButton__loadingAnimation 3s linear infinite}.OpalButton:not([viewType=clean])[disabled]{opacity:.5;pointer-events:none}.OpalGroup>.OpalButton:not([viewType=clean]):not(:first-child),.OpalGroup>:not(:first-child) .OpalButton:not([viewType=clean]){border-top-left-radius:0;border-bottom-left-radius:0;-webkit-box-shadow:inset 1px 0 rgba(0,0,0,.4);box-shadow:inset 1px 0 rgba(0,0,0,.4)}.OpalGroup>.OpalButton:not([viewType=clean]):not(:last-child),.OpalGroup>:not(:last-child) .OpalButton:not([viewType=clean]){border-top-right-radius:0;border-bottom-right-radius:0}.OpalSwitchMenu .OpalButton:not([viewType=clean]):not(:first-child){border-top-left-radius:0;border-bottom-left-radius:0;-webkit-box-shadow:inset 1px 0 rgba(0,0,0,.4);box-shadow:inset 1px 0 rgba(0,0,0,.4)}.OpalSwitchMenu .OpalButton:not([viewType=clean]):not(:last-child){border-top-right-radius:0;border-bottom-right-radius:0}.OpalButton[viewType=primary]{background:#1b91f8}.OpalButton[viewType=primary]:hover{background-color:#33a0ff}.OpalButton[viewType=primary]:active,.OpalButton[viewType=primary][checked]{background-color:#1371c3}.OpalButton[viewType=danger]{background:#f63159}.OpalButton[viewType=danger]:hover{background-color:#fd496d}.OpalButton[viewType=danger]:active,.OpalButton[viewType=danger][checked]{background-color:#d3173d}@-webkit-keyframes OpalButton__loadingAnimation{0%{background-position:0 0}to{background-position:60px 0}}@keyframes OpalButton__loadingAnimation{0%{background-position:0 0}to{background-position:60px 0}}";
