...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".OpalCalendar{display:block;width:300px;border:1px solid var(--grayColor850, hsl(0,0%,85%));border-radius:3px;background:#fff;color:var(--textColor500, hsl(208,9%,18%));text-shadow:none;font:16px/24px Verdana,Geneva,sans-serif;font-weight:400}.OpalCalendar .OpalCalendar__header{position:relative;padding:8px 44px;text-align:center}.OpalCalendar .OpalCalendar__btnPrevMonth,.OpalCalendar .OpalCalendar__btnNextMonth{position:absolute;top:0;bottom:0;margin:auto;padding:0;width:30px;height:30px;border:0;border-radius:50%;background:0 0;color:var(--grayColor500, hsl(0,0%,50%));cursor:pointer}.OpalCalendar .OpalCalendar__btnPrevMonth:hover,.OpalCalendar .OpalCalendar__btnNextMonth:hover{background:var(--grayColor900, hsl(0,0%,90%));color:var(--textColor500, hsl(208,9%,18%))}.OpalCalendar .OpalCalendar__btnPrevMonth:focus,.OpalCalendar .OpalCalendar__btnNextMonth:focus{outline:0}body:not(._noFocusHighlight) .OpalCalendar .OpalCalendar__btnPrevMonth:focus::after,body:not(._noFocusHighlight) .OpalCalendar .OpalCalendar__btnNextMonth:focus::after{position:absolute;top:2px;right:2px;bottom:2px;left:2px;border-radius:inherit;-webkit-box-shadow:inset 0 0 0 1px var(--primaryColor500, hsl(208,94%,50%));box-shadow:inset 0 0 0 1px var(--primaryColor500, hsl(208,94%,50%));content:'';pointer-events:none}.OpalCalendar .OpalCalendar__btnPrevMonth:active,.OpalCalendar .OpalCalendar__btnNextMonth:active{background:var(--grayColor800, hsl(0,0%,80%))}.OpalCalendar .OpalCalendar__btnPrevMonth[disabled],.OpalCalendar .OpalCalendar__btnNextMonth[disabled]{background:0 0;color:var(--textColor500, hsl(208,9%,18%));opacity:.3;pointer-events:none}.OpalCalendar .OpalCalendar__btnPrevMonth{left:8px}.OpalCalendar .OpalCalendar__btnNextMonth{right:8px}.OpalCalendar .OpalCalendar__btnPrevMonthIcon,.OpalCalendar .OpalCalendar__btnNextMonthIcon{position:absolute;top:0;right:0;bottom:0;left:0;display:block;margin:auto;width:18px;height:18px}.OpalCalendar .OpalCalendar__body{padding:0 8px 8px;text-align:center;cursor:default;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.OpalCalendar .OpalCalendar__weekDays,.OpalCalendar .OpalCalendar__days{width:100%;border-spacing:0;border-collapse:separate}.OpalCalendar .OpalCalendar__weekDay,.OpalCalendar .OpalCalendar__day{display:inline-block;-webkit-box-sizing:border-box;box-sizing:border-box;padding:5px 7px;width:14.2857%;border:1px solid transparent}.OpalCalendar .OpalCalendar__day{position:relative;border-radius:3px;cursor:pointer}.OpalCalendar .OpalCalendar__day:hover{background:var(--grayColor900, hsl(0,0%,90%))}.OpalCalendar .OpalCalendar__day:focus{outline:0}body:not(._noFocusHighlight) .OpalCalendar .OpalCalendar__day:focus::after{position:absolute;top:2px;right:2px;bottom:2px;left:2px;border-radius:inherit;-webkit-box-shadow:inset 0 0 0 1px var(--primaryColor500, hsl(208,94%,50%));box-shadow:inset 0 0 0 1px var(--primaryColor500, hsl(208,94%,50%));content:'';pointer-events:none}.OpalCalendar .OpalCalendar__day:active{background:var(--grayColor800, hsl(0,0%,80%))}.OpalCalendar .OpalCalendar__day[today]{text-decoration:underline}.OpalCalendar .OpalCalendar__day[not_in_current_month]{opacity:.45}.OpalCalendar .OpalCalendar__day[disabled]{background:0 0;opacity:.15;cursor:default}.OpalCalendar .OpalCalendar__day[selected]{color:var(--primaryColor450, hsl(208,94%,45%));opacity:1}";
