...
const template = [[1,,"header",["header"],,[[1,,"button",["btnPrevMonth"],[,[[,"type","button"],[,"disabled","{btnPrevMonthDisabled}"]]],[[1,,"OpalIcon",["btnPrevMonthIcon"],[,[[,"name","chevronLeft"]]],]]],[1,,"OpalSelect",["monthSelect"],[,[[,"size","s"],[,"value","['{shownMonth}']"]]],[[1,1,"repeat",,[,[[,"class","OpalSelect__menuContent"],[,"for","month in constructor.i18n.months"]]],[[1,,"OpalSelectOption",,[,[[,"value","{=$index}"],[,"text","{=month}"]]],]]]]],[3," "],[1,,"OpalSelect",["yearSelect"],[,[[,"size","s"],[,"value","['{shownYear}']"]]],[[1,1,"repeat",,[,[[,"class","OpalSelect__menuContent"],[,"for","year in years"]]],[[1,,"OpalSelectOption",,[,[[,"text","{=year}"]]],]]]]],[1,,"button",["btnNextMonth"],[,[[,"type","button"],[,"disabled","{btnNextMonthDisabled}"]]],[[1,,"OpalIcon",["btnNextMonthIcon"],[,[[,"name","chevronRight"]]],]]]]],[1,,"div",["body"],,[[1,,"div",["weekDays"],,[[1,,"div",["weekDaysRow"],,[[1,,"span",["weekDay"],[,[[1,"for","weekDay in weekDaysShort"]]],[[3,"{=weekDay}"]]]]]]],[1,,"div",["days"],,[[1,,"div",["daysRow"],[,[[1,"for","weekDays in days"]]],[[1,,"span",["day"],[,[[1,"for","day in weekDays"],[,"weekDay","{=day.weekDay}"],[,"today","{=day.today}"],[,"selected","{=day.selected}"],[,"notInCurrentMonth","{=day.notInCurrentMonth}"],[,"disabled","{=day.disabled}"],[,"tabindex","{=day.tabIndex}"],[,"data-date","{=day.date}"]]],[[3,"{=day.value}"]]]]]]]]]];
