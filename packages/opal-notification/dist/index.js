...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".OpalNotification__container{position:fixed;top:10px;right:20px;z-index:300;width:400px}.OpalNotification__container .OpalNotification__bar{position:relative;right:-200px;-webkit-box-sizing:border-box;box-sizing:border-box;margin:10px 0;padding:10px 40px 10px 20px;width:400px;border-radius:3px;background:#4b5d6c;-webkit-box-shadow:0 2px 4px rgba(0,0,0,.3);box-shadow:0 2px 4px rgba(0,0,0,.3);color:#fff;opacity:0;-webkit-transition:right .2s linear,opacity .2s linear;-o-transition:right .2s linear,opacity .2s linear;transition:right .2s linear,opacity .2s linear}.OpalNotification__container .OpalNotification__bar[view_type=primary]{background:#0887f7}.OpalNotification__container .OpalNotification__bar[view_type=success]{background:#49ab4d}.OpalNotification__container .OpalNotification__bar[view_type=danger]{background:#f44034}.OpalNotification__container .OpalNotification__bar[has_icon][icon_size=xs]{padding-left:48px}.OpalNotification__container .OpalNotification__bar[has_icon][icon_size=s]{padding-left:52px}.OpalNotification__container .OpalNotification__bar[has_icon][icon_size=m]{padding-left:56px}.OpalNotification__container .OpalNotification__bar[shown]{right:0;opacity:1}.OpalNotification__container .OpalNotification__icon{position:absolute;top:0;bottom:0;left:16px;margin:auto}.OpalNotification__container .OpalNotification__btnHide{position:absolute;top:0;right:10px;bottom:0;margin:auto;padding:0;width:24px;height:24px;border:0;background:0 0;color:#fff;opacity:.7;cursor:pointer;-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;transition:opacity .1s linear}.OpalNotification__container .OpalNotification__btnHide:hover{opacity:1}.OpalNotification__container .OpalNotification__btnHide:focus{outline:0}body:not(._noFocusHighlight) .OpalNotification__container .OpalNotification__btnHide:focus{outline:1px solid #0887f7}.OpalNotification__container .OpalNotification__btnHide:active{-webkit-transform:translateY(1px);-ms-transform:translateY(1px);transform:translateY(1px)}.OpalNotification__container .OpalNotification__btnHide[hide]{display:none}.OpalNotification__container .OpalNotification__btnHideIcon{position:absolute;top:0;right:0;bottom:0;left:0;display:block;margin:auto;width:16px;height:16px}";
