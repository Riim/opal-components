...
const template = [[1,,"span",["tags"],,[[1,1,"repeat",,[,[[,"for","tag in viewModel"],[,"trackBy","{_viewModelItemValueFieldName}"]]],[[1,,"span",["tag"],[,[[,"disabled","{tag |_isItemDisabled }"]]],[[3,"{tag |key(_viewModelItemTextFieldName) }"],[1,,"button",["btnRemoveTag"],[,[[,"type","button"]]],]]]]]]],[1,,"span",["control"],,[[1,,"span",["placeholder"],[,[[1,"if","placeholderShown"]]],[[3,"{placeholder}"]]],[1,,"OpalSelect",["select"],[,[[,"viewType","clean"],[,"multiple",""],[,"dataListKeypath","{_selectDataListKeypath}"],[,"dataListItemSchema","{dataListItemSchema |dump }"],[,"value","{paramValue}"],[,"viewModel","{viewModel}"],[,"viewModelItemSchema","{viewModelItemSchema |dump }"],[,"addItem","{addItem}"],[,"focused","{focused}"]]],[[1,,"OpalSignButton",["button"],[,[[,"class","OpalSelect__button"],[,"sign","plus"],[,"viewType","{viewType}"],[,"checkable",""],[,"tabIndex","{tabIndex}"],[,"disabled","{disabled}"]]],],[1,,"RnSlot",,[,[[,"class","OpalSelect__menuSlot"],[,"for","OpalSelect__menu"]]],[[1,,"OpalPopover",["menu"],[,[[,"class","OpalSelect__menu"],[,"position","{popoverPosition}"],[,"closeOn","mousedown"]]],[[1,,"RnSlot",,[,[[,"for","OpalSelect__menuHeader"]]],],[1,,"RnSlot",,[,[[,"for","OpalSelect__menuContent"]]],[[1,,"div",,[,[[1,"if","_selectDataListKeypath"],[,"class","OpalSelect__menuContent"]]],[[1,1,"cond",,[,[[,"if","dataList"]]],[[1,1,"repeat",,[,[[,"for","item in dataList"],[,"trackBy","{_dataListItemValueFieldName}"]]],[[1,,"OpalSelectOption",["dataListSelectOption","selectOption"],[,[[,"value","{item |key(_dataListItemValueFieldName) }"],[,"text","{item |key(_dataListItemTextFieldName) }"],[,"subtext","{item |key(_dataListItemSubtextFieldName) }"],[,"disabled","{item |key(_dataListItemDisabledFieldName) }"]]],]]],[1,,"RnSlot",["itemInputValidatorSlot"],[,[[,"class","OpalSelect__itemInputValidatorSlot"],[,"for","OpalSelect__itemInputValidator"]]],[[1,,"RnSlot",,[,[[,"class","OpalSelect__itemInputSlot"],[,"for","OpalSelect__itemInput"]]],]]]]],[1,1,"cond",,[,[[,"unless","dataList"],[,"acceptPending",""]]],[[1,,"OpalLoader",["menuLoader"],[,[[,"shown",""]]],]]]]],[1,,"OpalFilteredList",["menuFilteredList"],[,[[1,"unless","_selectDataListKeypath"],[,"class","OpalSelect__menuContent OpalSelect__filteredList"]]],[[1,,"RnSlot",,[,[[,"class","OpalFilteredList__queryInputSlot"],[,"for","OpalFilteredList__queryInput"]]],],[1,,"OpalLoadedList",["menuLoadedList"],[,[[,"class","OpalSelect__loadedList OpalFilteredList__list"],[,"dataProvider","{dataProvider}"]]],[[1,,"OpalSelectOption",["loadedListSelectOption","selectOption"],[,[[,"class","OpalLoadedList__listItem"],[,"value","{$item |key(_dataListItemValueFieldName) }"],[,"text","{$item |key(_dataListItemTextFieldName) }"],[,"subtext","{$item |key(_dataListItemSubtextFieldName) }"]]],]]]]]]],[1,,"RnSlot",,[,[[,"for","OpalSelect__menuFooter"]]],]]]]]]]]]];
