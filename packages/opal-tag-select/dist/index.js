...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".OpalTagSelect{display:inline}.OpalTagSelect .OpalTagSelect__tag{position:relative;top:-1px;display:inline-block;margin:2px 40px 2px 0;padding:0 10px 0 18px;border-top-left-radius:16px;border-bottom-left-radius:16px;background:var(--defaultColor500, hsl(208,18%,36%));color:#fff;vertical-align:middle;text-decoration:none;text-shadow:none;font:16px/32px Verdana,Geneva,sans-serif;font-weight:400;cursor:default}.OpalTagSelect .OpalTagSelect__tag[disabled]{margin-right:8px;padding-right:18px;border-top-right-radius:16px;border-bottom-right-radius:16px}.OpalTagSelect .OpalTagSelect__tag[disabled] .OpalTagSelect__btnRemoveTag{display:none}.OpalTagSelect .OpalTagSelect__btnRemoveTag{position:absolute;top:0;bottom:0;left:100%;display:block;padding:0;width:32px;border:0;border-radius:0;border-top-right-radius:16px;border-bottom-right-radius:16px;background:var(--defaultColor400, hsl(208,18%,28.8%));-webkit-box-shadow:inset 1px 0 rgba(0,0,0,.4);box-shadow:inset 1px 0 rgba(0,0,0,.4);cursor:pointer;-webkit-transition:background .1s linear;-o-transition:background .1s linear;transition:background .1s linear}.OpalTagSelect .OpalTagSelect__btnRemoveTag::before{position:absolute;top:0;right:0;bottom:0;left:0;margin:auto;width:12px;height:2px;background:#fff;content:''}.OpalTagSelect .OpalTagSelect__btnRemoveTag:hover{background:var(--defaultColor500, hsl(208,18%,36%))}.OpalTagSelect .OpalTagSelect__btnRemoveTag:focus{outline:0}body:not(._noFocusHighlight) .OpalTagSelect .OpalTagSelect__btnRemoveTag:focus::after{position:absolute;top:2px;right:2px;bottom:2px;left:2px;border:1px solid rgba(255,255,255,.8);border-radius:inherit;content:'';pointer-events:none}.OpalTagSelect .OpalTagSelect__btnRemoveTag:active{background:var(--defaultColor300, hsl(208,18%,21.6%))}.OpalTagSelect .OpalTagSelect__control{display:inline-block;white-space:nowrap;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.OpalTagSelect .OpalTagSelect__placeholder{margin-right:8px}.OpalTagSelect .OpalTagSelect__button{margin:1px 0}.OpalTagSelect .OpalTagSelect__menuLoader{border-top-width:70px;border-bottom-width:70px}.OpalTagSelect[view_type=primary] .OpalTagSelect__tag{background:var(--primaryColor500, hsl(208,94%,50%))}.OpalTagSelect[view_type=primary] .OpalTagSelect__btnRemoveTag{background:var(--primaryColor400, hsl(208,94%,40%))}.OpalTagSelect[view_type=primary] .OpalTagSelect__btnRemoveTag:hover{background:var(--primaryColor500, hsl(208,94%,50%))}.OpalTagSelect[view_type=primary] .OpalTagSelect__btnRemoveTag:active{background:var(--primaryColor300, hsl(208,94%,30%))}.OpalTagSelect[view_type=success] .OpalTagSelect__tag{background:var(--successColor500, hsl(122,40%,48%))}.OpalTagSelect[view_type=success] .OpalTagSelect__btnRemoveTag{background:var(--successColor400, hsl(122,40%,38.4%))}.OpalTagSelect[view_type=success] .OpalTagSelect__btnRemoveTag:hover{background:var(--successColor500, hsl(122,40%,48%))}.OpalTagSelect[view_type=success] .OpalTagSelect__btnRemoveTag:active{background:var(--successColor300, hsl(122,40%,28.8%))}.OpalTagSelect[view_type=warning] .OpalTagSelect__tag{background:var(--warningColor500, hsl(40,100%,50%))}.OpalTagSelect[view_type=warning] .OpalTagSelect__btnRemoveTag{background:var(--warningColor400, hsl(40,100%,40%))}.OpalTagSelect[view_type=warning] .OpalTagSelect__btnRemoveTag:hover{background:var(--warningColor500, hsl(40,100%,50%))}.OpalTagSelect[view_type=warning] .OpalTagSelect__btnRemoveTag:active{background:var(--warningColor300, hsl(40,100%,30%))}.OpalTagSelect[view_type=danger] .OpalTagSelect__tag{background:var(--dangerColor500, hsl(4,90%,58%))}.OpalTagSelect[view_type=danger] .OpalTagSelect__btnRemoveTag{background:var(--dangerColor400, hsl(4,90%,49.6%))}.OpalTagSelect[view_type=danger] .OpalTagSelect__btnRemoveTag:hover{background:var(--dangerColor500, hsl(4,90%,58%))}.OpalTagSelect[view_type=danger] .OpalTagSelect__btnRemoveTag:active{background:var(--dangerColor300, hsl(4,90%,41.2%))}.OpalTagSelect[disabled]{pointer-events:none}.OpalTagSelect[disabled] .OpalTagSelect__placeholder{opacity:.5}";
