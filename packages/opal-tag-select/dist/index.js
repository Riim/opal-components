...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".OpalTagSelect{display:inline}.OpalTagSelect .OpalTagSelect__tag{position:relative;top:-1px;display:inline-block;margin:2px 40px 2px 0;padding:0 10px 0 18px;border-top-left-radius:16px;border-bottom-left-radius:16px;background:#4b5d6c;color:#fff;vertical-align:middle;text-decoration:none;text-shadow:none;font:16px/32px Verdana,Geneva,sans-serif;font-weight:400;cursor:default}.OpalTagSelect .OpalTagSelect__tag[disabled]{margin-right:8px;padding-right:18px;border-top-right-radius:16px;border-bottom-right-radius:16px}.OpalTagSelect .OpalTagSelect__tag[disabled] .OpalTagSelect__btnRemoveTag{display:none}.OpalTagSelect .OpalTagSelect__btnRemoveTag{position:absolute;top:0;bottom:0;left:100%;display:block;padding:0;width:32px;border:0;border-radius:0;border-top-right-radius:16px;border-bottom-right-radius:16px;background:#3d4b57;-webkit-box-shadow:inset 1px 0 rgba(0,0,0,.4);box-shadow:inset 1px 0 rgba(0,0,0,.4);cursor:pointer;-webkit-transition:background .1s linear;-o-transition:background .1s linear;transition:background .1s linear}.OpalTagSelect .OpalTagSelect__btnRemoveTag::before{position:absolute;top:0;right:0;bottom:0;left:0;margin:auto;width:12px;height:2px;background:#fff;content:''}.OpalTagSelect .OpalTagSelect__btnRemoveTag:hover{background:#4b5d6c}.OpalTagSelect .OpalTagSelect__btnRemoveTag:focus{outline:0}body:not(._noFocusHighlight) .OpalTagSelect .OpalTagSelect__btnRemoveTag:focus::after{position:absolute;top:2px;right:2px;bottom:2px;left:2px;border:1px solid rgba(255,255,255,.8);border-radius:inherit;content:'';pointer-events:none}.OpalTagSelect .OpalTagSelect__btnRemoveTag:active{background:#2e3942}.OpalTagSelect .OpalTagSelect__control{display:inline-block;white-space:nowrap;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.OpalTagSelect .OpalTagSelect__placeholder{margin-right:8px}.OpalTagSelect .OpalTagSelect__button{margin:1px 0}.OpalTagSelect .OpalTagSelect__menuLoader{border-top-width:70px;border-bottom-width:70px}.OpalTagSelect[view_type=primary] .OpalTagSelect__tag{background:#0887f7}.OpalTagSelect[view_type=primary] .OpalTagSelect__btnRemoveTag{background:#066cc6}.OpalTagSelect[view_type=primary] .OpalTagSelect__btnRemoveTag:hover{background:#0887f7}.OpalTagSelect[view_type=primary] .OpalTagSelect__btnRemoveTag:active{background:#055194}.OpalTagSelect[view_type=success] .OpalTagSelect__tag{background:#49ab4d}.OpalTagSelect[view_type=success] .OpalTagSelect__btnRemoveTag{background:#3a883d}.OpalTagSelect[view_type=success] .OpalTagSelect__btnRemoveTag:hover{background:#49ab4d}.OpalTagSelect[view_type=success] .OpalTagSelect__btnRemoveTag:active{background:#2c682e}.OpalTagSelect[view_type=warning] .OpalTagSelect__tag{background:#fa0}.OpalTagSelect[view_type=warning] .OpalTagSelect__btnRemoveTag{background:#c80}.OpalTagSelect[view_type=warning] .OpalTagSelect__btnRemoveTag:hover{background:#fa0}.OpalTagSelect[view_type=warning] .OpalTagSelect__btnRemoveTag:active{background:#960}.OpalTagSelect[view_type=danger] .OpalTagSelect__tag{background:#f44034}.OpalTagSelect[view_type=danger] .OpalTagSelect__btnRemoveTag{background:#a51309}.OpalTagSelect[view_type=danger] .OpalTagSelect__btnRemoveTag:hover{background:#f44034}.OpalTagSelect[view_type=danger] .OpalTagSelect__btnRemoveTag:active{background:#790e06}.OpalTagSelect[disabled]{pointer-events:none}.OpalTagSelect[disabled] .OpalTagSelect__placeholder{opacity:.5}";
