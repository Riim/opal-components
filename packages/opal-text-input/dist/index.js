...
const template = [[1,,"div",["textareaContainer"],[,[[1,"if","multiline"]]],[[1,,"textarea",["textarea","textField"],[,[[,"rows","{rows}"],[,"name","{inputName}"],[,"placeholder","{placeholder}"],[,"tabindex","{tabIndex}"],[,"disabled","{disabled}"]]],],[1,,"div",["textareaHeight"],,]]],[1,,"input",["input","textField"],[,[[1,"unless","multiline"],[,"type","{_inputType}"],[,"name","{inputName}"],[,"placeholder","{placeholder}"],[,"tabindex","{tabIndex}"],[,"disabled","{disabled}"]]],],[1,,"OpalIcon",["startIcon"],[,[[1,"if","startIcon"],[,"name","{startIcon}"]]],],[1,,"RnSlot",["endIconSlot"],[,[[,"for","endIcon"],[,"shown","{endIconShown}"]]],[[1,,"OpalIcon",["endIcon"],[,[[1,"if","endIcon"],[,"name","{endIcon}"]]],]]],[1,,"button",["btnClear"],[,[[1,"if","clearable"],[,"type","button"],[,"shown","{btnClearShown}"],[,"tabindex","{disabled |cond(-1, 0) }"]]],[[1,,"OpalIcon",["btnClearIcon"],[,[[,"name","cross"]]],]]],[1,,"OpalLoader",["loader"],[,[[1,"if","loading"],[,"size","s"],[,"shown",""]]],],[1,,"button",["btnShowPassword"],[,[[1,"if","inputType |eq(\"password\")"],[,"type","button"]]],[[1,1,"IfThen",,[,[[,"if","_inputType |eq(\"password\")"]]],[[1,,"OpalIcon",[,"btnShowPasswordIcon"],[,[[,"name","eye"],[,"strokeWidth","2"]]],]]],[1,1,"IfElse",,[,[[,"if","_inputType |eq(\"password\")"]]],[[1,,"OpalIcon",[,"btnShowPasswordIcon"],[,[[,"name","crossedOutEye"],[,"strokeWidth","2"]]],]]]]]];
