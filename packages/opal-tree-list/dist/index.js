(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@riim/opal-checkbox"), require("cellx"), require("@riim/opal-button"), require("@riim/opal-select"), require("@riim/opal-utils"), require("@riim/object-assign-polyfill"), require("rionite"), require("cellx-decorators"));
	else if(typeof define === 'function' && define.amd)
		define(["@riim/opal-checkbox", "cellx", "@riim/opal-button", "@riim/opal-select", "@riim/opal-utils", "@riim/object-assign-polyfill", "rionite", "cellx-decorators"], factory);
	else if(typeof exports === 'object')
		exports["@riim/opal-tree-list"] = factory(require("@riim/opal-checkbox"), require("cellx"), require("@riim/opal-button"), require("@riim/opal-select"), require("@riim/opal-utils"), require("@riim/object-assign-polyfill"), require("rionite"), require("cellx-decorators"));
	else
		root["@riim/opal-tree-list"] = factory(root["@riim/opal-checkbox"], root["cellx"], root["@riim/opal-button"], root["@riim/opal-select"], root["@riim/opal-utils"], root["@riim/object-assign-polyfill"], root["rionite"], root["cellx-decorators"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__7ATV__, __WEBPACK_EXTERNAL_MODULE_P7z7__, __WEBPACK_EXTERNAL_MODULE_X6DG__, __WEBPACK_EXTERNAL_MODULE_jL6t__, __WEBPACK_EXTERNAL_MODULE_qQaz__, __WEBPACK_EXTERNAL_MODULE_u2fl__, __WEBPACK_EXTERNAL_MODULE_u4yd__, __WEBPACK_EXTERNAL_MODULE_yOaX__) {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "QdML");
/******/ })
/************************************************************************/
/******/ ({
...
const opal_utils_1 = __webpack_require__("qQaz");
...
module.exports = (function(d) {
        ...
        if (head) {
            var style = d.createElement('style');
            style.type = 'text/css';
            style.textContent = ".OpalTreeListItem{display:block}.OpalTreeListItem .OpalTreeListItem__head{display:table}.OpalTreeListItem .OpalTreeListItem__btnToggleChildren{position:relative;display:table-cell;visibility:hidden;padding-right:6px;padding-left:2px;vertical-align:middle;text-align:center}.OpalTreeListItem .OpalTreeListItem__btnToggleChildren:focus{outline:0}body:not(._noFocusHighlight) .OpalTreeListItem .OpalTreeListItem__btnToggleChildren:focus::after{position:absolute;top:1px;right:4px;bottom:1px;left:0;border-radius:2px;-webkit-box-shadow:inset 0 0 0 1px #0887f7;box-shadow:inset 0 0 0 1px #0887f7;content:'';pointer-events:none}.OpalTreeListItem .OpalTreeListItem__btnToggleChildren[checked] .OpalTreeListItem__btnToggleChildrenIcon{-webkit-transform:rotate(90deg);-ms-transform:rotate(90deg);transform:rotate(90deg)}.OpalTreeListItem .OpalTreeListItem__btnToggleChildrenIcon{display:block;width:14px;height:14px;-webkit-transition:-webkit-transform .1s linear;transition:-webkit-transform .1s linear;-o-transition:transform .1s linear;transition:transform .1s linear;transition:transform .1s linear,-webkit-transform .1s linear;-webkit-transform:rotate(0);-ms-transform:rotate(0);transform:rotate(0)}.OpalTreeListItem .OpalTreeListItem__contentSlotWrapper{display:table-cell;width:100%}.OpalTreeListItem .OpalTreeListItem__children{display:none;padding-left:24px}.OpalTreeListItem[opened]>.OpalTreeListItem__children{display:block}.OpalTreeListItem[nesting_level='0']{font-weight:700}.OpalTreeListItem[nesting_level='1']{font-weight:400}.OpalTreeListItem[has_children]>.OpalTreeListItem__head .OpalTreeListItem__btnToggleChildren{visibility:visible}";
            head.appendChild(style);
            return style;
        }
        return null;
