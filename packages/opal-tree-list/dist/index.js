...
const template = [[1,1,"IfThen",,[,[[,"if","listShown"]]],[[1,,"OpalTreeListItem",["item"],[,[[1,"for","$item in filteredDataTreeList"],[,"dataTreeList","{dataTreeList}"],[,"filteredDataTreeList","{filteredDataTreeList}"],[,"dataTreeListItemValueFieldName","{_dataTreeListItemValueFieldName}"],[,"dataTreeListItemTextFieldName","{_dataTreeListItemTextFieldName}"],[,"viewModel","{viewModel}"],[,"viewModelItemValueFieldName","{_viewModelItemValueFieldName}"],[,"viewModelItemTextFieldName","{_viewModelItemTextFieldName}"],[,"indexpath","[{$index}]"],[,"query","{query}"],[,"opened","{query |bool }"],[,"nestingLevel","0"],[,"hasChildren","{$item.children.length |gt(0) }"]]],[[1,,"RnSlot",,[,[[,"cloneContent",""],[,"getContext","{_getListItemContext}"]]],[[1,,"OpalCheckbox",["selectionControl"],[,[[,"checked","{$selected}"],[,"indeterminate","{$indeterminate}"]]],[[3,"{$item |key(_dataTreeListItemTextFieldName) }"]]]]]]],[1,,"RnSlot",["nothingFoundSlot"],[,[[1,"unless","filteredDataTreeList.length"],[,"for","nothingFound"]]],[[1,,"span",["nothingFound"],,[[1,,"span",["nothingFoundMessage"],,[[3,"{\"Ничего не найдено\" |t }"]]]]]]]]],[1,,"OpalLoader",["loader"],[,[[1,"unless","listShown"],[,"shown",""]]],]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const template = [[1,,"div",["head"],,[[1,,"OpalButton",["btnToggleChildren"],[,[[,"viewType","clean"],[,"checkable",""],[,"checked","{opened}"]]],[[1,,"OpalIcon",["btnToggleChildrenIcon"],[,[[,"name","chevronRight"]]],]]],[1,,"span",["contentSlotWrapper"],,[[1,,"RnSlot",["contentSlot"],[,[[,"cloneContent",""]]],]]]]],[1,,"div",["children"],[,[[1,"if","dataTreeListItem.children.length"]]],[[1,,"OpalTreeListItem",["item"],[,[[1,"for","$item in dataTreeListItem.children"],[,"dataTreeList","{dataTreeList}"],[,"filteredDataTreeList","{filteredDataTreeList}"],[,"dataTreeListItemValueFieldName","{_dataTreeListItemValueFieldName}"],[,"dataTreeListItemTextFieldName","{_dataTreeListItemTextFieldName}"],[,"viewModel","{viewModel}"],[,"viewModelItemValueFieldName","{_viewModelItemValueFieldName}"],[,"viewModelItemTextFieldName","{_viewModelItemTextFieldName}"],[,"indexpath","[{indexpath},{$index}]"],[,"query","{query}"],[,"opened","{query |bool }"],[,"nestingLevel","{indexpath.length}"],[,"hasChildren","{$item.children.length |gt(0) }"]]],[[1,,"RnSlot",,[,[[,"cloneContent",""],[,"getContext","{_getListItemContext}"]]],]]]]]];
/* harmony default export */ __webpack_exports__["default"] = (template);
