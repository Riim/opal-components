...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".OpalSignButton{display:inline-block;line-height:0}.OpalSignButton .OpalSignButton__control{position:relative;padding:0;border:0;background:0 0;color:inherit;white-space:nowrap;font:inherit;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.OpalSignButton .OpalSignButton__control:focus{outline:0}body:not(._noFocusHighlight) .OpalSignButton .OpalSignButton__control:focus::after{position:absolute;top:-1px;right:0;bottom:1px;left:-3px;border:1px solid var(--primaryColor500, hsl(208,94%,50%));border-radius:3px;content:'';pointer-events:none}.OpalSignButton .OpalSignButton__control:active{top:1px}.OpalSignButton .OpalSignButton__sign{position:relative;top:-1px;display:inline-block;-webkit-box-sizing:border-box;box-sizing:border-box;margin:3px 3px 3px 0;width:28px;height:28px;border:2px solid;border-radius:50%;vertical-align:middle;-webkit-transition:border-color .1s linear;-o-transition:border-color .1s linear;transition:border-color .1s linear}.OpalSignButton .OpalSignButton__sign::before,.OpalSignButton .OpalSignButton__sign::after{position:absolute;top:0;right:0;bottom:0;left:0;margin:auto;width:12px;height:2px;-webkit-transition:background .1s linear;-o-transition:background .1s linear;transition:background .1s linear}.OpalSignButton .OpalSignButton__sign::after{-webkit-transform:rotate(90deg);-ms-transform:rotate(90deg);transform:rotate(90deg)}.OpalSignButton[sign=plus] .OpalSignButton__control:hover .OpalSignButton__sign,.OpalSignButton[sign=plus] .OpalSignButton__control:active .OpalSignButton__sign{border-color:var(--primaryColor600, hsl(208,94%,60%))}.OpalSignButton[sign=plus] .OpalSignButton__control:hover .OpalSignButton__sign::before,.OpalSignButton[sign=plus] .OpalSignButton__control:hover .OpalSignButton__sign::after,.OpalSignButton[sign=plus] .OpalSignButton__control:active .OpalSignButton__sign::before,.OpalSignButton[sign=plus] .OpalSignButton__control:active .OpalSignButton__sign::after{background:var(--primaryColor600, hsl(208,94%,60%))}.OpalSignButton[sign=plus] .OpalSignButton__sign{border-color:var(--primaryColor500, hsl(208,94%,50%))}.OpalSignButton[sign=plus] .OpalSignButton__sign::before,.OpalSignButton[sign=plus] .OpalSignButton__sign::after{background:var(--primaryColor500, hsl(208,94%,50%));content:''}.OpalSignButton[sign=minus] .OpalSignButton__control:hover .OpalSignButton__sign,.OpalSignButton[sign=minus] .OpalSignButton__control:active .OpalSignButton__sign{border-color:var(--dangerColor600, hsl(4,90%,66.4%))}.OpalSignButton[sign=minus] .OpalSignButton__control:hover .OpalSignButton__sign::before,.OpalSignButton[sign=minus] .OpalSignButton__control:active .OpalSignButton__sign::before{background:var(--dangerColor600, hsl(4,90%,66.4%))}.OpalSignButton[sign=minus] .OpalSignButton__sign{border-color:var(--dangerColor500, hsl(4,90%,58%))}.OpalSignButton[sign=minus] .OpalSignButton__sign::before{background:var(--dangerColor500, hsl(4,90%,58%));content:''}.OpalSignButton[view_type=default] .OpalSignButton__control:hover .OpalSignButton__sign,.OpalSignButton[view_type=default] .OpalSignButton__control:active .OpalSignButton__sign{border-color:var(--defaultColor600, hsl(208,18%,43.2%))}.OpalSignButton[view_type=default] .OpalSignButton__control:hover .OpalSignButton__sign::before,.OpalSignButton[view_type=default] .OpalSignButton__control:hover .OpalSignButton__sign::after,.OpalSignButton[view_type=default] .OpalSignButton__control:active .OpalSignButton__sign::before,.OpalSignButton[view_type=default] .OpalSignButton__control:active .OpalSignButton__sign::after{background:var(--defaultColor600, hsl(208,18%,43.2%))}.OpalSignButton[view_type=default] .OpalSignButton__sign{border-color:var(--defaultColor500, hsl(208,18%,36%))}.OpalSignButton[view_type=default] .OpalSignButton__sign::before,.OpalSignButton[view_type=default] .OpalSignButton__sign::after{background:var(--defaultColor500, hsl(208,18%,36%))}.OpalSignButton[view_type=primary] .OpalSignButton__control:hover .OpalSignButton__sign,.OpalSignButton[view_type=primary] .OpalSignButton__control:active .OpalSignButton__sign{border-color:var(--primaryColor600, hsl(208,94%,60%))}.OpalSignButton[view_type=primary] .OpalSignButton__control:hover .OpalSignButton__sign::before,.OpalSignButton[view_type=primary] .OpalSignButton__control:hover .OpalSignButton__sign::after,.OpalSignButton[view_type=primary] .OpalSignButton__control:active .OpalSignButton__sign::before,.OpalSignButton[view_type=primary] .OpalSignButton__control:active .OpalSignButton__sign::after{background:var(--primaryColor600, hsl(208,94%,60%))}.OpalSignButton[view_type=primary] .OpalSignButton__sign{border-color:var(--primaryColor500, hsl(208,94%,50%))}.OpalSignButton[view_type=primary] .OpalSignButton__sign::before,.OpalSignButton[view_type=primary] .OpalSignButton__sign::after{background:var(--primaryColor500, hsl(208,94%,50%))}.OpalSignButton[view_type=success] .OpalSignButton__control:hover .OpalSignButton__sign,.OpalSignButton[view_type=success] .OpalSignButton__control:active .OpalSignButton__sign{border-color:var(--successColor600, hsl(122,40%,57.6%))}.OpalSignButton[view_type=success] .OpalSignButton__control:hover .OpalSignButton__sign::before,.OpalSignButton[view_type=success] .OpalSignButton__control:hover .OpalSignButton__sign::after,.OpalSignButton[view_type=success] .OpalSignButton__control:active .OpalSignButton__sign::before,.OpalSignButton[view_type=success] .OpalSignButton__control:active .OpalSignButton__sign::after{background:var(--successColor600, hsl(122,40%,57.6%))}.OpalSignButton[view_type=success] .OpalSignButton__sign{border-color:var(--successColor500, hsl(122,40%,48%))}.OpalSignButton[view_type=success] .OpalSignButton__sign::before,.OpalSignButton[view_type=success] .OpalSignButton__sign::after{background:var(--successColor500, hsl(122,40%,48%))}.OpalSignButton[view_type=warning] .OpalSignButton__control:hover .OpalSignButton__sign,.OpalSignButton[view_type=warning] .OpalSignButton__control:active .OpalSignButton__sign{border-color:var(--warningColor600, hsl(40,100%,60%))}.OpalSignButton[view_type=warning] .OpalSignButton__control:hover .OpalSignButton__sign::before,.OpalSignButton[view_type=warning] .OpalSignButton__control:hover .OpalSignButton__sign::after,.OpalSignButton[view_type=warning] .OpalSignButton__control:active .OpalSignButton__sign::before,.OpalSignButton[view_type=warning] .OpalSignButton__control:active .OpalSignButton__sign::after{background:var(--warningColor600, hsl(40,100%,60%))}.OpalSignButton[view_type=warning] .OpalSignButton__sign{border-color:var(--warningColor500, hsl(40,100%,50%))}.OpalSignButton[view_type=warning] .OpalSignButton__sign::before,.OpalSignButton[view_type=warning] .OpalSignButton__sign::after{background:var(--warningColor500, hsl(40,100%,50%))}.OpalSignButton[view_type=danger] .OpalSignButton__control:hover .OpalSignButton__sign,.OpalSignButton[view_type=danger] .OpalSignButton__control:active .OpalSignButton__sign{border-color:var(--dangerColor600, hsl(4,90%,66.4%))}.OpalSignButton[view_type=danger] .OpalSignButton__control:hover .OpalSignButton__sign::before,.OpalSignButton[view_type=danger] .OpalSignButton__control:hover .OpalSignButton__sign::after,.OpalSignButton[view_type=danger] .OpalSignButton__control:active .OpalSignButton__sign::before,.OpalSignButton[view_type=danger] .OpalSignButton__control:active .OpalSignButton__sign::after{background:var(--dangerColor600, hsl(4,90%,66.4%))}.OpalSignButton[view_type=danger] .OpalSignButton__sign{border-color:var(--dangerColor500, hsl(4,90%,58%))}.OpalSignButton[view_type=danger] .OpalSignButton__sign::before,.OpalSignButton[view_type=danger] .OpalSignButton__sign::after{background:var(--dangerColor500, hsl(4,90%,58%))}.OpalSignButton[checked] .OpalSignButton__control{top:1px}.OpalSignButton[disabled]{opacity:.5;pointer-events:none}.OpalSignButton[disabled] .OpalSignButton__control{cursor:default}";
