...
import { OpalCalendar } from '../OpalCalendar';
import { parseDate } from '../OpalCalendar/parseDate';
import { OpalDropdown } from '../OpalDropdown';
import { OpalTextInput } from '../OpalTextInput';
import { OpalTextInputValidator } from '../OpalTextInputValidator';
import './index.css';
...
export class OpalDateInput extends BaseComponent {
	...
	elementAttached() {
		...
		this.listenTo(
			this.$<BaseComponent>('text-input')!.element,
			'click',
